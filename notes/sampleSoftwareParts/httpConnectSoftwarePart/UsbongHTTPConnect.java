...
public class UsbongHTTPConnect {
	...
	private static final String STORE_PUZZLE_FOR_THE_DAY_UPLOAD = "usbong_time/server/addAutoGeneratedPuzzleToStorage.php";
...
//		json.put("myKey", "myValue");    
	...
	//private void processUpload() throws Exception {
		...
		JSONObject json = processRecordedStepsInputForUpload(args);	
...
//		System.out.println("json: "+json.toString());
		...
		try {
			...
			HttpPost request = new HttpPost(serverIpAddress+STORE_PUZZLE_FOR_THE_DAY_UPLOAD);
						
			//System.out.println(">>"+serverIpAddress+STORE_PUZZLE_FOR_THE_DAY_UPLOAD);
...
//		json.put("myKey", "myValue");    
	...
	//added by Mike, 20221217
	private JSONObject processRecordedStepsInputForUpload(String[] args) throws Exception {
		JSONObject json = new JSONObject();
//		json.put("myKey", "myValue");    
		...
		for (int i=0; i<args.length; i++) {									
			...
			//edited by Mike, 20190917
			json.put("sRecordedSteps", s.trim());
		}
